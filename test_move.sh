...
curl -X POST "http://localhost:8004/servos/2/move" -H "Content-Type: application/json" -d '{"angle": 0}'
echo -e "\n"
sleep 2
...
curl -X POST "http://localhost:8004/servos/config" \
     ...
     -d '{"detach_enabled": true, "hold_time": 0.1, "min_pulse_width": 0.0006, "max_pulse_width": 0.0010}'
echo -e "\n"

echo "Testing servo movement with fine-tuned pulse widths..."
curl -X POST "http://localhost:8004/servos/1/move" \
     -H "Content-Type: application/json" \
     -d '{"angle": 90}'
echo -e "\n"
...
curl -X POST "http://localhost:8004/servos/1/hold"
echo -e "\n"

curl -X POST "http://localhost:8004/servos/1/release"
echo -e "\n"
...
curl -X POST "http://localhost:8004/servos/hold-all"
echo -e "\n"

curl -X POST "http://localhost:8004/servos/release-all"
echo -e "\n"
...
curl -X POST "http://localhost:8004/servos/1/center"
echo -e "\n"
