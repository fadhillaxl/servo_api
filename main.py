...
class ServoConfig(BaseModel):
    ...
    hold_time: float = Field(default=0.01, ge=0.1, le=10.0, description="Time to hold position before detaching (seconds)")
    min_pulse_width: float = Field(default=0.0006, ge=0.0001, le=0.002, description="Minimum pulse width in seconds (0.1ms to 2ms)")
    max_pulse_width: float = Field(default=0.002, ge=0.002, le=0.003, description="Maximum pulse width in seconds (2ms to 3ms)")
